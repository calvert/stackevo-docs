...
environments). The information that are exposed by the extensibility mechansim
must further be minimize to only expose the information that are acutually needed
